...
<head>
    ...
    <title>Prenotazioni tavolo</title>
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <?php include 'html_snippets/navbar.php'; create_navbar(); ?>
    <div class="container">
        <h1>Prenotazioni tavolo</h1>
        <form action="/reserved_tables_list.php" method="post">
            ...
            <button type="submit" class="btn btn-primary">Visualizza tavoli</button>
        </form>
    </div>
