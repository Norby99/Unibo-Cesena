...
queste, vi sono una modalità di previsione planare, una previsione DC e 33 previsioni angolari.
TODO: spiegare matematicamente come vengono applicate queste due nuove modalità (vedi video ~ 13:20)
...
Nella trasformazione viene introdotta la tecnologia Residual Quad-tree Transform (RQT), utilizzata
all'interno delle TU, che possono avere dimensioni variabili. Questa tecnologia consente di applicare
una trasformata diversa a blocchi di grandi dimensioni rispetto a quelli piccoli, permettendo di mantenere
più dettagli nei blocchi piccoli. Nei blocchi grandi, utilizzati su aree uniformi con pochi dettagli, si
ottiene un'elevata compressione a scapito di una qualità mediocre del dettaglio, un compromesso accettabile
poiché queste aree sono prive di dettagli significativi. La regolazione del dettaglio avviene semplicemente
grazie alla creazione delle TU, che possono avere dimensioni variabili da 4x4 a 32x32, permettendo di regolare
il livello di dettaglio mantenuto in base all'area analizzata.
La tecnologia RQT deve il suo nome al fatto che, per memorizzare le TB, vengono utilizzate delle quad tree, come illustrato dai rami rossi nella Figura~\ref{fig:chroma_CTB}.
