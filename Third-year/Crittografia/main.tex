...
dei residui e vengono divisi in blocchi rettangolari 8x8 e viene applicata la trasformata discreta del coseno
...
\begin{enumerate}
    ...
    Figura~\ref{fig:DCT_example} si può notare come partendo da un immagine, come si possa risalire
    ad essa mediante una somma mi matrici prese dalla tabella DCT.
\end{enumerate}
...
maggiore è il risparmio di memoria, ma al contempo peggiora la qualità dell'immagine. Così facendo
alla fine si otterrà una matrice di quantizzazione che tiene conto di ogni valore di divisione di
ogni blocco.

Organizzare i blocchi in base alla loro frequenza inoltre, è vantaggioso in quanto facilita una codifica e
